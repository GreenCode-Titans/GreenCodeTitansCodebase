...
EMISSION_FACTORS = {
    "Kenya": {
        ...
        "Diet": 0.97,  # kgCO2/meal, 2.5kgco2/kg
        "Waste": 0.1  # kgCO2/kg
    }
}
...
# Streamlit app code
st.title("Personal Carbon Footprint Calculator⚠️")
...
if st.button("Calculate CO2 Emissions"):
    ...
    with col4:
        ...
        st.warning("Kenya’s total Greenhouse gas (GHG) emissions as of 2013 were 60.2 million metric tons of carbon dioxide equivalent (MtCO2e), totaling 0.13% of global GHG emissions. The agriculture sector emitted 62.8% of total emissions, followed by the energy sector (31.2%), industrial processes sector (4.6%), and waste sector (1.4%).")
